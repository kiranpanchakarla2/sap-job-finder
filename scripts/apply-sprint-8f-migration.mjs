...
async function run() {
  ...
  const sql = fs.readFileSync("supabase/migrations/20260816190000_contact_notifications.sql", "utf-8");
  console.log("Executing migration 20260816190000_contact_notifications.sql...");
